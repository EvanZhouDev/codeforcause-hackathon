        ...
        <>
            ...
            <dialog id="my_modal_1" className="modal">
                <div className="modal-box">
                    ...
                    <p className="py-4">First, name your class. Afterwards, go to Mange Students and hit Enroll Students to continue.</p>
                    <div>
                    ...
                    <p className="py-4 opacity-50">You can rename your class at any time. To make sure the name is unique, it is recommended to include your period.</p>
