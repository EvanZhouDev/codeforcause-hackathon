...
<div className="flex justify-stretch">
                                ...
                                <h1 className="website-title pt-5 !-pt-2">Students Registered in Class 1</h1>
                                <StudentTable />
                            </div>
                        </div>
                ...
                <div className="bg-base-100 outline outline-1 outline-[#CAC8C5] w-[48.5%] ml-[0.5%] h-[90vh] rounded-xl">
                    ...
                    <div className="ml-[5%] mt-5">
                        <h1 className="website-title !text-2xl !text-secondary-content">Configure Your Attendance Session:</h1>
